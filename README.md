...
## Documentation
You'll find a readme with all the documentation within each package. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes or implement new features in a pull request.
